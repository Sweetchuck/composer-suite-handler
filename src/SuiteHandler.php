...
class SuiteHandler
{
    ...
    protected string $pluginName = 'composer-suite';
    ...
    public function generate(array $composerData, array $actions): array
    {
        ...
        unset($composerData['extra'][$this->pluginName]);
     ...
     * @return $this
     */
    public function generateAddComment(
        array &$composerData,
        // phpcs:disable Generic.Files.LineLength.TooLong
        string $comment = 'DO NOT EDIT THIS FILE. Content of this file can be overwritten by the `suite:generate` command.'
        ...
        array_unshift($composerData['_comment'], $comment);
    ...
    public function whatToDo(string $fileName, array $dataNew): string
    {
        ...
        if ($contentOld === null || $contentOld === false) {
            return 'create';
        }
    ...
    public function collectSuiteComposerFiles(string $composerFile): array
    {
        $base = preg_replace(
            '/\.json$/',
            '',
            pathinfo($composerFile, PATHINFO_BASENAME),
        );
     ...
     *
     * @return array<string, suite-definition>
     */
    public function collectSuiteDefinitions(string $composerFileName, array $extra): array
    {
        ...
        $suiteDefinitionDir = "$projectRoot/.{$this->pluginName}";

        return $this->mergeSuiteDefinitions(
            $this->collectSuiteDefinitionsFromExtra($extra),
            $this->collectSuiteDefinitionsFromDir($suiteDefinitionDir, $this->pluginName . '.'),
        );
    }
    ...
    {
        $suiteDefinitions = $extra[$this->pluginName] ?? [];
    ...
    public function parseSuiteDefinitionFiles(\Iterator $files, string $fileNamePrefix): array
    {
        ...
        while ($files->valid()) {
            ...
            /** @phpstan-var suite-definition  $suiteDefinition */
            $suiteDefinition = Utils::decode($fileContent);
     ...
     * @param suite-action-config-basic $config
     *
     * @return $this
     */
     ...
     * @return $this
     */
    protected function actionAppend(array &$data, array $config)
    {
        $config = array_replace_recursive(
            [
                'parents' => [],
    ...
    /**
     * @param array<mixed> $data
     * @param suite-action-config-insert $config
     *
     * @return $this
     */
     ...
     * @return $this
     */
    protected function actionInsert(array &$data, array $config)
    {
        $config = array_replace_recursive(
            [
                'parents' => [],
    ...
    /**
     * @param array<mixed> $data
     * @param suite-action-config-sort-normal $config
     *
     * @return $this
     */
    protected function actionSortNormal(array &$data, array $config)
    {
        $config = array_replace_recursive(
            [
                'parents' => [],
