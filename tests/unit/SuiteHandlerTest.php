...
/**
 * @covers \Sweetchuck\ComposerSuiteHandler\SuiteHandler
 * @covers \Sweetchuck\ComposerSuiteHandler\RequirementComparer
 */
class SuiteHandlerTest extends TestBase
{
     ...
     */
    public function testGenerateSuccess(array $expected, array $rootData, array $actions): void
    {
        $suiteHandler = new SuiteHandler();
        $this->tester->assertSame($expected, $suiteHandler->generate($rootData, $actions));
    }

    public function testGenerateFailInvalidSortFunction(): void
    {
        $rootData = [
            'tags' => [
                'a',
    ...
    public function testGenerateFailUnknownAction(): void
    {
    ...
    /**
     * @param array<mixed> $vfsStructure
    ...
    public function testCollectSuiteComposerFiles(): void
    {
        $expected = [
            'composer.a.json' => 'a',
            'composer.b.json' => 'b',
     ...
     */
    public function testCollectSuiteDefinitions(array $expected, array $vfsStructure, array $extra): void
    {
        $vfs = vfsStream::setup(
            'root',
            0777,
